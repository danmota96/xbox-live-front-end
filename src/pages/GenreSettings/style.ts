...
export const SettingsGenreCard = styled.div`
	${({ theme }) => css`
    width: 14rem;
    height: 12rem;
    border-radius: 8px;
...
export const SettingsGenreEditCardButton = styled.button`
  ${({ theme }) => css`
    height: 3.25rem;
    width: 50%;
...
export const SettingsGenreDeleteCardButton = styled.button`
  ${({ theme }) => css`
    height: 3.25rem;
    width: 50%;
